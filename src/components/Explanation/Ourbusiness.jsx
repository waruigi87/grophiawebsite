...
function Ourbusiness() {
    ...
    return (
        <>
            <div className="surface-third pb-12">
                    ...
                    >
                        {businessInformationdata.map((item) => (
                            <motion.div
                                ...
                                key={item.id}
                                className="p-6 border-gray-200 rounded-lg hover:shadow-xl surface-secondary transition-shadow duration-300 flex justify-between"
                            >
                                {item.id % 2 === 0 ? (
                                    <>
                                        <div className="text-black mr-6 flex-1 space-y-4">
                                            ...
                                            <button
                                                onClick={() => {}}
                                                className="border border-green-900 rounded-md px-3 py-2 text-xs hover:bg-green-900 hover:text-white hover:scale-110 transition duration-300 ease-in-out  "
                                            >
                                                詳細はこちらへ
                                            </button>
                                        </div>
                                        <div className="w-40 h-40 ">
                                            <img
                                                className="w-[400px] h-full object-cover rounded-full"
                                                src={item.imgUrl}
                                                alt=""
                                            />
                                        </div>
