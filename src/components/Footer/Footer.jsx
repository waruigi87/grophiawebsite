...
function Footer() {
  return (
    <>
        <div className='bg-[#2e6417] text-white'>
            <div className='container mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8'>
                    ...
                    <div>
                        ...
                        <p className='text-sm opacity-80'>〒123-4567 東京都渋谷区渋谷1-2-3 グロフィアビル5F</p>
                    </div>
                    <div>
                    ...
                    <ul className="space-y-1 text-sm opacity-80">
                        <li><a href="#" className="hover:text-green-200 transition">Instagram</a></li>
                        <li><a href="#" className="hover:text-green-200 transition">Facebook</a></li>
                        <li><a href="#" className="hover:text-green-200 transition">X (旧Twitter)</a></li>
                    </ul>
                    </div>
