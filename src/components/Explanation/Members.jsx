            ...
            <div className='container mx-auto px-4'>
                ...
                className='grid grid-cols-1 md:grid-cols-3 gap-6 pb-12'>
                    ...
                    memberData.map((member) => (
                        ...
                        key={member.id} className='bg-white rounded-3xl shadow-lg p-6 text-center'>
                            <img src={member.imgUrl} alt={member.name} className='w-32 h-32 mx-auto rounded-full mb-4 object-cover'/>
